 ...
 *
 */
public class CheckContinuousSubarrayKTimesOfSum_HH {
	...
	public boolean checkSubarraySum_(int[] nums, int k) {
		...
		for (int i = 0; i < nums.length; i++) {
			...
			// If duplicate sum exists, record the left most one in order to let
			// the largest size
	...
	public static void main(String[] args) {
		CheckContinuousSubarrayKTimesOfSum_HH s = new CheckContinuousSubarrayKTimesOfSum_HH();
